...
urlpatterns = [
    ...
    path("review/<uuid:review_id>/like/", views.toggle_like, name="toggle_like"),
    path("review/<uuid:review_id>/comment/", views.add_comment, name="add_comment"),
    ...
    path("list/<uuid:list_id>/remove/<int:game_id>/", views.remove_from_list, name="remove_from_list"),
